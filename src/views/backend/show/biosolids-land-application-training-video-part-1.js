            ...
            <Row>
               <Col lg="12">
                  <div className="trending-info season-info g-border">
                     ...
                     <ul className="trending-dec w-100 mb-0 info-share"> 
                        <li>Historical Overview of Biosolids Management</li>
                        <li>Basics of Title 40 of the US Code of Federal Regulations Part 503</li>
                        <li>Biosolids Management Practices</li>
                        <li>Monitoring, Record keeping and Reporting Requirements</li>
                        <li>Exceptional Quality (EQ) Biosolids</li>
                     </ul>
