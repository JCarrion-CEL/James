                        ...
                        <Row>
                            <Col sm="12" className="overflow-hidden">
                                <div className="d-flex align-items-center justify-content-between">
                                    <h4 className="main-title">Biosolids</h4>
                                </div>
                                    ...
                                    <Swiper 
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className="block-images1 block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Biosolids Pro 180 Part 1</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                                        <span className="text-white">5h 30m</span>
                                                    </div>
                                                    <div className="hover-buttons">
                                                    {!subscribedUser && <Link to="/pricing-plan" role="button" className="btn btn-hover">
                                                            <i className="fa fa-rocket mr-1" aria-hidden="true"></i>
                                                            Subscribe Now
                                                        </Link> }
                                                    {subscribedUser && <Link to="/biosolids-pro-180-part-1" role="button" className="btn btn-hover">
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className="block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Biosolids Pro 180 Part 2</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                    ...
                                    <Swiper 
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className="block-images1 block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">The Illusion</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                                        <div className="badge badge-secondary p-1 mr-2">10+</div>
                                                        <span className="text-white">3h 15m</span>
                                                    </div>
                                                    <div className="hover-buttons">
                                                        <Link to="/biosolids-pro-180-part-1" role="button" className="btn btn-hover">
                                                            <i className="fa fa-play mr-1" aria-hidden="true"></i>
                                                            Play Now
                                                        </Link>
                                                    </div>
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className="block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Burning</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                                        <div className="badge badge-secondary p-1 mr-2">13+</div>
                                                        <span className="text-white">2h 20m</span>
                                                    </div>
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className=" block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Hubby Kubby</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                                        <div className="badge badge-secondary p-1 mr-2">9+</div>
                                                        <span className="text-white">2h 40m</span>
                                                    </div>
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className=" block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Open Dead Shot</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
                                        ...
                                        <SwiperSlide className="slide-item">
                                            <div className="block-images position-relative">
                                                ...
                                                <div className="block-description">
                                                    <h6 className="iq-title"><Link to="/biosolids-pro-180-part-1">Jumboo Queen</Link></h6>
                                                    <div className="movie-time d-flex align-items-center my-2">
