...
import MessageModal from '../../../components/SubscriptionMessageModal'
...
const Homepage =()=>{
                     ...
                     <Row className="align-items-center  iq-ltr-direction h-100 ">
                        <Col xl="6" lg="12" md="12">
                           ...
                           <div className="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-y="80" data-iq-delay="0.8">
                              <Link to="/biosolids-pro-180-part-1" className="btn btn-hover iq-button">
                  ...
                  <div className="slider-inner h-100">
                     <Row className="align-items-center  iq-ltr-direction h-100 ">
                        <Col xl="6" lg="12" md="12">
                           ...
                           <div className="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-y="80" data-iq-delay="0.8">
                              <Link to="/biosolids-pro-180-part-2" className="btn btn-hover iq-button">
                                 <i className="fa fa-play mr-2" aria-hidden="true"></i>Play Now
                              </Link>
                           </div>
                        </Col>
                              ...
                              <div className=" block-images position-relative">
                                 ...
                                 <div className="block-description">
                                    ...
                                    <div className="hover-buttons">
                                       <Link to="/biosolids-pro-180-part-1" role="button" className="btn btn-hover iq-button">
                           ...
                           <SwiperSlide as="li">
                              <div className="block-images position-relative">
                                 ...
                                 <div className="block-description">
                                    ...
                                    <div className="hover-buttons">
                                       <Link to="/biosolids-pro-180-part-2" role="button" className="btn btn-hover iq-button">
                                          <i className="fa fa-play mr-1" aria-hidden="true"></i>
                                          Play Now
                                       </Link>
                                    </div>
   ...
   }, [user, hasPlan, toggler1, toggler2, toggler3])
