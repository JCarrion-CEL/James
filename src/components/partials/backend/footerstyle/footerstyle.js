...
import footer1 from '../../../../assets/images/footer/google-play-badge.png'
import footer2 from '../../../../assets/images/footer/app-store-ios.png'
                        ...
                        <Row className="footer-standard">
                            <Col lg="7">
                                ...
                                <div className="widget text-left">
                                    <div className="textwidget">
                                        <p><small>© 2022 CACHE ENVIRONMENTAL LABORATORIES, PC. All Rights Reserved. All videos and shows on this platform are trademarks of, and all related images and content are the property of, CACHE ENVIRONMENTAL LABORATORIES, PC. Duplication and copy of this is strictly prohibited. All rights reserved.</small></p>
                                    </div>
                                </div>                        
                            </Col>
                            <Col lg="2" md="6" className="mt-4 mt-lg-0">
                                ...
                                <ul className="info-share"> 
                                    <li><Link target="_blank" to="https://www.linkedin.com/company/cache-environmental-laboratories-pc"><i className="fa fa-linkedin"></i></Link></li>
                                    <li><Link target="_blank" to="https://www.facebook.com/cachelabs"><i className="fa fa-facebook"></i></Link></li>
                                    <li><Link target="_blank" to="https://www.instagram.com/cache_environmental/"><i className="fa fa-instagram"></i></Link></li>
                                </ul>
                            ...
                            <Col lg="3" md="6" className="mt-4 mt-lg-0">
                                <div className="widget text-left">
                                    <div className="textwidget">
                                        <h6 className="footer-link-title">BLAST PRO App</h6>
                                        <div className="d-flex align-items-center">
                                            <Link className="app-image" to="https://play.google.com/store/apps/details?id=com.cachecel.blast">
                                                <img src={footer1} alt="play-store"/>
                                            </Link><br/>
                                            <Link className="ml-3 app-image" to="https://apps.apple.com/us/app/blast-cel/id1590720889"><img src={footer2} alt="app-store"/></Link>
                                        </div>
                                    </div>
                                </div>
                            </Col>
