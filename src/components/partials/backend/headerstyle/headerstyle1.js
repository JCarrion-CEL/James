...
const  HeaderStyle1 =(props) =>{
    ...
    const LoginLogout = useMemo(() => {
        if (user) {
            return <Link to="/" onClick={() => logout()}>Log Out</Link>

        } else {
            return <Link to="/extra-pages/login">Already Subscribed?</Link>
                            ...
                            <Col sm="12">
                                <Navbar expand="lg" className="p-0">
                                    ...
                                    <Link  className="navbar-brand" to="/">
                                        <img className="img-fluid logo" src={logo} alt="biosolids pro 180" />
                                    </Link>
                                                ...
                                                {/* <Dropdown.Menu className="iq-sub-dropdown iq-user-dropdown" align="right">
                                                    <Card className="shadow-none m-0">
                                                        <Card.Body className="p-0 pl-3 pr-3">
                                                            ...
                                                            <Link to="/pricing-plan" className="iq-sub-card setting-dropdown">
                                                                <div className="media align-items-center">
                                                                    <div className="right-icon">
                                                                        <i className="ri-settings-4-line text-primary"></i>
                                                                    </div>
